...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field furls on 'Tag'
        db.create_table('furl_tag_furls', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tag', models.ForeignKey(orm['furl.tag'], null=False)),
            ('furl', models.ForeignKey(orm['furl.furl'], null=False))
        ))
        db.create_unique('furl_tag_furls', ['tag_id', 'furl_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field furls on 'Tag'
        db.delete_table('furl_tag_furls')
    ...
    models = {
        ...
        'furl.tag': {
            ...
            'furls': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['furl.Furl']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
